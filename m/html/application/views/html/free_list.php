<?
	if(!$this->input->get('cate_no')){
		alert(cdir()."/dh/free_list/?cate_no=1-6");
	}
...
<div id="container" style="background-color:#F0F0f0">
	...
	<div class="pb50">
		...
		<div class="bottm_inner freelist_btn">
			...
			<p class="gray mb20 mt10">
				※낱개배송은 3팩 이상 주문시 구매가능합니다.<br>
				<?php
				if($this->input->get('cate_no') == '2-12'){
					?>
					※100g이 아니라 150g/200g으로 넉넉합니다.<br>
					※멸치볶음,서리태콩,어묵등 일부품목 80-110g입니다.<br>
					<?php
				}
				?>
				※배송일을 기준으로 주문하실 수 있으니, 참고해주세요.<br>
				※정기배송을 이용중이면, 무료배송일자를 선택하실 수 있습니다.
			</p>
			<!-- <span>알레르기 체크</span> -->
