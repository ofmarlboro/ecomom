...
<div id="container" style="background: #FAFAFA">
  ...
  <!-- inner -->
  <div class="pb50">
    <div class="header_img" style="height: 58px;">
      <img src="/m/image/sub/bgg1.jpg" alt="" style="width:100%; ">
...
<form method="post" name="recomfrm" id="recomfrm" action="<?=cdir()?>/dh/regular_pay">
  ...
  <div class="">
    ...
    <div class="order_opt_wrap">
      <div class="order_opt_tint" style="padding: 5px 4.5% 5px;">
        <div class="order_set test1">
          <?php
      ...
      <!-- //order_opt_tint -->
			...
			<div class="pay pay01 clearfix">
				<div class="fl" style="color: #8a8a8a;font-size: 14px;">총 상품금액</div>
				...
				<div class="pay_in clearfix">
					...
					<div class="fl" style="font-size: 14px;">할인적용가</div>
				</div>
      </div>

      <p class="ml15 mt10">
        <!-- <button type="button" class="plain menuview"></button> -->
        <img src="/m/image/sub/order_menu.jpg" alt="" width="70px">
				<span class="no-ct" style="font-weight:500;color:#767676;display:block;font-size: 11px;">
					(상단에서 주문설정을 하시면,
					메뉴가 자동으로 표시됩니다)
				</span>
			</p>
      ...
      <div class="order_sched_wrap">
        ...
        <div class="alrg_chk float-wrap" style="display:none;">
          <p class="tit">알레르기 체크<a href="javascript:;" class="alery_view"></a></p>
...
<!--   <div class="bottom_bar bottom_bar03 bottom_bar03_1">
  ...
  <p class="align-c">
        ...
        if(!$this->session->userdata('USERID')){
          ...
          if($recom_overlap){
          ?>
          <button type="button" class="plain" title="주문하기" onclick="frmChk('recomfrm')"><img src="/m/image/sub/order_0_03.png" alt="주문하기">주문하기</button>
          <?php
          }
          else{
          ?>
          <button type="button" class="plain" title="주문하기" onclick="alert('장바구니에 정기배송이 1건 담겨있습니다.\n\n추가 주문을 원하시는경우 주문을 진행하신 후 구매 부탁드리며\n변경을 원하시는경우 장바구니에서 삭제후 주문해 주시기 바랍니다.');location.href='<?=cdir()?>/dh_order/shop_cart'"><img src="/m/image/sub/order_0_03.png" alt="주문하기">주문하기</button>
          <?php
          }
        }
        ?>
