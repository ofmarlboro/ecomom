  ...
  <div class="inner mypage">
    ...
    <div class="deposit-current">
      ...
      <div class="deposit-current__money"><strong><?=number_format($total_deposit)?></strong>원</div>
		...
		<form name="dps_schfrm" id="dps_schfrm">
    ...
    <div class="deposit-form">
      ...
      <div class="deposit-form__date">
        <input type="text" class="deposit-picker datepicker" name="sdate" value="<?=$this->input->get('sdate')?$this->input->get('sdate'):''?>" id="" size="10"> <img src="/image/sub/cal_icon.png" alt="">&nbsp;~&nbsp;
        <input type="text" class="deposit-picker datepicker" name="edate" value="<?=$this->input->get('edate')?$this->input->get('edate'):''?>" id="" size="10"> <img src="/image/sub/cal_icon.png" alt="">
      </div>
