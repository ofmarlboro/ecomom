			<ul class="tabMenu01">
				...
				foreach($cate_row as $cr){
					...
					<?php
					if($cate_cnt == 2 || $cate_cnt == 5){
						?>
						</ul>
						<ul class="tabMenu01 <?=($cate_cnt == 5)?"mb20":"";?>">
						<?php
					}
				}
				?>
				<!-- <li class=""><a href="">곡류</a></li>
				<li class=""><a href="">채소류</a></li> -->
			</ul>

			<!--
			<ul class="tabMenu01">
				<li class=""><a href="">육류/가금류/난류</a></li>
				<li class=""><a href="">어패류/해조류</a></li>
				<li class=""><a href="">버섯류/서류</a></li>
			</ul>
			<ul class="tabMenu01 mb20">
				<li class=""><a href="">과실류/종실/견과류</a></li>
				<li class=""><a href="">두유/유제품류</a></li>
				<li class=""><a href="">식용유지류/양념류</a></li>
			</ul> -->
			<img src="/image/sub/ico_bg.jpg" alt="" width="200px">
			<ul class="study_li">
				<?php
				if($list){
					$cnt = 0;
			...
			<form name="bbs_search_form" action="<?=cdir()?>/<?=$this->uri->segment(1)?>/lists/<?=$bbs->code?>/" onSubmit="return false;">
				<div class="board-search">
					...
					<input type="button" value="검색" class="btn-search" onclick="javascript:search();">
				</div>
			</form>