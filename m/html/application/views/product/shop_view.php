...
<script>
	...
	*/
	...
	$(function(){
		...
		*		경로 : /m/html/dh_product/noght_market_apply
		*
		*************************************************************************************/
		if($row->night_market_tuto){
			?>
			<p class="mt20 align-c">
				<button type="button" class="plain" <?php if(!$this->session->userdata('USERID')){?>onclick="alert('로그인 후 이용해주세요.')"<?php }else{?>onclick="location.href='/m/html/dh/exp_apply/<?=$row->idx?>'"<?php }?>>
		...
		*************************************************************************************/
			...
			<div class="prod-info-wrap prod_hj">
				...
				<ul class="prod-info p_hj">
					<li class="ar">
						...
						if($row->idx == "452" || $row->cate_no == "10"){
							?>
							<input name="goods_cnt" id="goods_cnt" value="1" readonly>
							<?php
						}
						else{
							?>
							<button type="button" class="vol-down" onclick="goodsCntChange('d')">감소</button>
							<input name="goods_cnt" id="goods_cnt" value="1" readonly>
							<button type="button" class="vol-up" onclick="goodsCntChange('u')">추가</button>
							<?php
						}
						?>
						</span>
						<p><?if($row->old_price){?><del><?=number_format($option_row->price+$row->old_price)?></del> <span class="unit">원</span> <img src="/image/sub/ar.jpg" alt=""><?}?>
						<em class='total_price'><?=number_format($row->shop_price)?></em> <span class="unit">원</span></p>
				...
				<div class="prod-total">
					...
					if( $row->deliv_grp == "무료배송"
						|| $row->idx=="452" || $row->idx=="485" || $row->idx == "543" || $row->idx == "505"
						|| $row->idx == "554"
						|| $row->idx == "878"
					){
						?>
						<p class="gray"><em>무료배송</em></p>
						<?php
					}
					else{
						if($row->cate_no == "10"){
						?>
						<p class="gray">
							배송비:<?=number_format($shop_info['express_money'])?>원<br>
						</p>
						<?php
						}
						...
						<p class="gray">
							배송비:<?=number_format($shop_info['express_money'])?>원<br>
							<?=number_format($shop_info['express_free'])?>원 이상<br>
							무료배송
						</p>
						<?php
						}
					...
					<span class="total_price"><?=number_format($row->shop_price)?></span>
					<span class="unit" style="padding-right: 4.5%;">원</span>
				</div>
				<!-- END 총 가격 -->

				<ul class="pro_option sel-wrap">
					<?php
					if($row->delivery_date_use == "admin"){
					...
					<li class="clearfix order_opt date_00">
						<a href="javascript:;" class="btn_b01">배송일 선택</a>
						<div class="selbox">
							<button type="button" onClick="toggleSelBox(this, event);"><span class="week_day_count_span" id="deliv_btn">지정된 배송일에 발송되는 상품</span></button>
							<ul>
					...
					?>
					<li class="clearfix order_opt date_00">
						<a href="javascript:;" class="btn_b01">예약배송에 추가</a>
						<div class="selbox">
							<button type="button" onClick="toggleSelBox(this, event);"><span class="week_day_count_span" id="deliv_btn">배송일 선택</span></button>
							<ul>
								<li><input type="radio" name="deliv_date" value="selec" id="deliv_date0"><label for="deliv_date0">배송일 직접 선택</label></li>
								<?php
					...
					*/
					?>
					<li class="ac date-sel" style="display:none;">
						<span onclick="javascript:$('input[name=date_bind]').focus();">배송일 선택</span>
			...
			if($row->cate_no == '10'){	//구매제한
				...
				?>
				<button type="button" class="plain" onclick="<?if($this->session->userdata('USERID')){?>sendOrder()<?}else{?>alert('로그인 후 주문이 가능합니다.');location.href='<?=cdir()?>/dh_member/login'<?}?>">
				<img src="/image/sub/btn_order2.jpg" alt="주문하기">
				</button>
				<?php
			}
	...
	<!-- inner -->
				...
				if($row->idx == "485"){	//2020 햅쌀
					...
					<!-- 2020 햅쌀 시작 -->
							...
							<div class="ac">
								...
								<div id="cts02" class="pt90">
									...
									<iframe width="100%" height="315" src="https://www.youtube.com/embed/OOuKpKWp0Nk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								...
								<div id="cts03" class="pt90">
									...
									<!-- <img src="/image/sub/oh_ssal_2020_09.jpg" alt=""> -->
					...
					<script type="text/javascript">
							...
							<div class="ac">
								...
								<div id="cts01" class="">
									...
									<!-- <img src="/_data/attach/plupload/yangyangpick_02.jpg" title="yangyangpick_02.jpg"> -->
								...
								<div id="cts02" class="">
									...
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/080n-dxyBUk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									<img src="/_data/attach/plupload/yangyangpick_05.jpg" title="yangyangpick_05.jpg">
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/S3K4_sfrDqw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								...
								<div id="cts03" class="">
									...
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/8xrobH-v8Qc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

									<img src="/_data/attach/plupload/yangyangpick2_03.jpg" title="yangyangpick2_03.jpg">
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/UQPNktdc5mY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

									<img src="/_data/attach/plupload/yangyangpick2_05.jpg" title="yangyangpick2_05.jpg">
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/QvB6-HAWXTA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									<img src="/_data/attach/plupload/yangyangpick2_07.jpg" title="yangyangpick2_07.jpg">
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/chVrfNzPyq0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					...
					<script type="text/javascript">
							...
							<div class="ac">
								...
								<div id="cts01" class="">
									...
									<a href="https://ecomommeal.co.kr/m/html/dh/bfood_order_free1/?cate_no=1-10">
								...
								<div id="cts02" class="">
									...
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/no6cOJfwe6I" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
								...
								<div id="cts03" class="">
									...
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/89_cnl6ss6E" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
									<img src="/_data/attach/plupload/yangyangpick4_2_03.jpg" title="yangyangpick4_2_03.jpg">
									<iframe width="100%" height="215" src="https://www.youtube.com/embed/wJpBbyJWKcA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					...
					<div class="ac">
						...
						<div class="cts01 pt90 ac" id="cts01">
							...
							<a href="/m/html/dh_product/prod_view/553">
								<img src="/_data/attach/plupload/yangyangpick5_02.jpg" title="yangyangpick5_02.jpg">
							</a>
							<a href="/m/html/dh/bfood_order_free1/?cate_no=1-10">
						...
						<div class="cts02 ac" id="cts02">
							...
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/PwiTE2tpZWw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						...
						<div class="cts03 ac" id="cts03">
							...
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/aDByWpRVhgI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


							<img src="/_data/attach/plupload/yangyangpick5_2_03_2.jpg" title="yangyangpick5_2_03_2.jpg"><br style="clear:both;">


							<iframe width="100%" height="215" src="https://www.youtube.com/embed/ccmZ-WtWDoQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					...
					<div class="ac">
						...
						<!-- 2번 섹션 -->
						<div class="cts02 ac" id="cts02">
							<img src="/_data/attach/plupload/yangyangpick6_06_2.jpg">
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/0vnSQ_q8AFE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<img src="/_data/attach/plupload/yangyangpick6_08_2.jpg">
						</div>

						<!-- 3번 섹션 -->
						<div class="cts03 ac" id="cts03">
							<img src="/_data/attach/plupload/yangyangpick6_2_01_1.jpg">
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/E9QBk8RMgIQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<img src="/_data/attach/plupload/yangyangpick6_2_03_1.jpg">
					...
					<div class="ac">
						...
						<div class="cts01 pt90 ac" id="cts01">
							...
							<!-- 첫구매맘 이동 -->
							<a href="/m/html/dh_product/prod_view/561?&cate_no=10">
						...
						<!-- 2번 섹션 -->
						<div class="cts02 ac" id="cts02">
							<img src="/_data/attach/plupload/yangyangpick7_06_3.jpg" title="yangyangpick7_06_3.jpg">
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/dkmGveXAbEQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<img src="/_data/attach/plupload/yangyangpick7_08_2.jpg" title="yangyangpick7_08_2.jpg">
						</div>

						<!-- 3번 섹션 -->
						<div class="cts03 ac" id="cts03">
							<img src="/_data/attach/plupload/yangyangpick7_2_01.jpg" title="yangyangpick7_2_01.jpg">
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/1FKRCsjfAeU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<img src="/_data/attach/plupload/yangyangpick7_2_03.jpg" title="yangyangpick7_2_03.jpg">
							<!-- <a href="/html/dh_product/prod_view/552" target="_blank">
								<img src="/_data/attach/plupload/yangyangpick6_2_04.jpg">
							</a>
							<a href="/html/dh_product/prod_view/540" target="_blank">
					...
					<div class="ac">
						...
						<div class="cts02 ac" id="cts02">
							...
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/8NkIV4rcWk4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						...
						<div class="cts03 ac" id="cts03">
							...
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/cqTiF5jsGjk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					...
					<div class="ac">
						...
						<div class="cts01 pt90 ac" id="cts01">
							...
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/Cel_cuCu210" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
							<div>
						...
						<div class="cts02 ac" id="cts02">
							...
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/gvlUBtnTNUw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
						...
						<div class="cts03 ac" id="cts03">
							...
							<iframe width="100%" height="215" src="https://www.youtube.com/embed/JhJ64JuI8QI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					...
					<div class="ac">
                        ...
                        <div class="cts01 pt90 ac" id="cts01">
                            ...
                            <a href="/m/html/dh_product/prod_view/805">
                                <img src="/_data/attach/plupload/Untitled-2_02.jpg" alt="">
                            </a>

                            <a href="/m/html/dh_product/prod_view/806/?cate_no=3">
                        ...
                        <div class="cts02 ac" id="cts02">
                            ...
                            <iframe width="100%" height="215" src="https://www.youtube.com/embed/bqzTzeBJtDw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </div>
                        ...
                        <div class="cts03 ac" id="cts03">
                            ...
                            <iframe width="100%" height="215" src="https://www.youtube.com/embed/T1syWV6fZaI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					...
					<div class="ac">
                        ...
                        <!-- 1번 섹션 -->
                        <div class="cts01 pt90 ac" id="cts01">
													<a href="<?=cdir()?>/dh/event03"><img src="/image/sub/top_event_11ekyy.jpg" alt=""></a>

                            <img src="/_data/attach/plupload/yangyangpick11_01.jpg" alt="">
                        ...
                        <div class="cts02 ac" id="cts02">
                            ...
                            <iframe width="100%" height="215" src="https://www.youtube.com/embed/dIzri1rwfbg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        ...
                        <div class="cts03 ac" id="cts03">
                            ...
                            <iframe width="100%" height="215" src="https://www.youtube.com/embed/OOrQTFqsCMw" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					...
					<div class="ac">
                        ...
                        <div class="cts01 ac" id="cts01">
							<a href="<?=cdir()?>/dh/event03"><img src="/image/sub/yangyangpick12_01.jpg" alt=""></a>
							<a href="/m/html/dh_product/prod_view/835?&type=nmk&cate_no=3"><img src="/image/sub/yasijang_banner.jpg" alt=""></a>
		...
		<p class="ac mt40">
			...
			if($row->idx == '972' || $row->idx == '973'){
				?>
				<a href="<?=cdir()?>/dh/preview02#set05" class="btn_g fz16">목록으로</a>
				<?php
			}
			else
			*/
			if($row->cate_no == '7'){
				?>
				<a href="<?=cdir()?>/dh/preview" class="btn_g fz16">목록으로</a>
				<?php
			}
			else{
				?>
