	...
	<tr>
		...
		foreach($graph as $tdate=>$gp){
			...
			<th>
				...
				<div class="brown_box" style="top: 100%;"><?if($arr_cnt <= 7){?><?=$tdate?><?}else{ echo numberToWeekname($tdate); echo "<BR>"; echo date("H",strtotime($tdate.":00:00")); }?></div>
			</th>
			<?php
		}
		?>
