	...
	<input type="hidden" name="moveIdx" id="moveIdx" value="">
						...
						<div class="float-wrap">
							<h3 class="icon-cate float-l">메뉴 관리</h3>
							<p class="float-r">
						...
						<p class="align-r mt10 ft-xs">선택한 메뉴 이동<span class="ml10"></span>
	...
	function delItem()
	{
		...
		$(".imsi").remove();
		$("#addIndex").val(0);
		$('.cate_view').html('<h3 class="icon-pen">카테고리 상세설정</h3><p class="pt80 align-c" style="border-top:2px solid #666;">왼쪽에서 메뉴를 선택해주세요.</p>');
	}
