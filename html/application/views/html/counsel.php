	...
	<div class="inner">
		<div class="counsel__wrap">
			...
			<div class="counsel__msg01">
				실제 상담시간은 약 10분정도 소요되며 예약하신 시간 내에 방문하시면 됩니다. <br>
			...
			<p class="counsel__param02">개인정보약관</p>
