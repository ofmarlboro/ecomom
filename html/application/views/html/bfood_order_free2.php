...
?>
	...
	<div id="container">
		...
		<div class="mid_cate_wrap">
			<div class="inner">
				<ul class="mid_cate">
					<li <?if($cate_no == "1-6"){?>class="on"<?}?>><a href="<?=cdir()?>/dh/bfood_order_free1/?cate_no=1-6"><span class="icon i1"></span>
							<p class="tit"><em>5개월 전후</em>준비기</p>
						</a>
					</li>
					<li <?if($cate_no == "1-7"){?>class="on"<?}?>><a href="<?=cdir()?>/dh/bfood_order_free1/?cate_no=1-7"><span class="icon i2"></span>
							<p class="tit"><em>5~6개월</em>초기</p>
						</a>
					</li>
					<li <?if($cate_no == "1-8"){?>class="on"<?}?>><a href="<?=cdir()?>/dh/bfood_order_free1/?cate_no=1-8"><span class="icon i3"></span>
							<p class="tit"><em>7~8개월</em>중기 준비기</p>
						</a>
					</li>
					<li <?if($cate_no == "1-9"){?>class="on"<?}?>><a href="<?=cdir()?>/dh/bfood_order_free1/?cate_no=1-9"><span class="icon i3"></span>
							<p class="tit"><em>7~8개월</em>중기</p>
						</a>
					</li>
					<li <?if($cate_no == "1-10"){?>class="on"<?}?>><a href="<?=cdir()?>/dh/bfood_order_free1/?cate_no=1-10"><span class="icon i4"></span>
							<p class="tit"><em>9~12개월</em>후기</p>
						</a>
					</li>
					<li <?if($cate_no == "1-11"){?>class="on"<?}?>><a href="<?=cdir()?>/dh/bfood_order_free1/?cate_no=1-11"><span class="icon i6"></span>
				...
				<div class="order_opt_light">
					<table class="order_opt price_tbl">
						<tbody>
							...
							<tr>
								<th>총 계</th>
								<td class="all_price" style="font-size:36px;color:red;">
