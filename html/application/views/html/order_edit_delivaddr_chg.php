		...
		<div id="container">
			...
			?>
				<div class="layer_pop_inner">
					<h1>
						<span class="btn_yy" style="margin-right:10px"><?=$deliv_type_name?></span>배송지 변경
					</h1>
					...
					<div class="bg">
						...
						<div class="ac bd">
							<a href="javascript:;" class="btn_big" onclick="change_deliv_addr_none()">변경</a>
			...
			?>
				<div class="layer_pop_inner">
					...
					<div class="bg">
						...
						<select name="deliv_addr" id="" class="pop_sel mb5" onchange="call_deliv_addr(this.value)">
						...
						<br>
						<input type="text" class="pop_in addr1 wid100" name="addr1" id="addr1" readonly value="<?=$row->addr1?>">
						<input type="hidden" class="zipcode" name="zipcode" id="zipcode" value="<?=$row->zipcode?>">
						<p style="height:2px;"></p>

						<!-- <input type="<?=($row->deliv_addr == "self")?"text":"hidden";?>" class="pop_in addr2 wid100" name="addr2" id="addr2" value="<?=$row->addr2?>"> -->
						<input type="test" class="pop_in addr2 wid100" name="addr2" id="addr2" readonly value="<?=$row->addr2?>">
						...
						<?php
						if($this->session->userdata('USERID') == $member_info->userid){
						?>
						<p class="blue fs12 mt10">
						...
						<div class="ac bd">
							<a href="javascript:;" class="btn_big" onclick="change_deliv_addr()">변경</a>
							<a href="javascript:;" class="btn_big" onclick='self.close()'>취소</a>
						</div>
					</div>
					</form>
