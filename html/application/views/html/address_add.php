		...
		<table class="address-list write-mode">
			...
			<tbody>
				...
				<tr>
					<th>연락처</th>
					<td>
						<input type="text" id="receiv-call1" style="width:60px" name="phone1" value="<?=($type=="home")?$member->phone1:$member->{$type._phone1};?>" msg="연락처를"> -
						<input type="text" id="receiv-call2" style="width:60px" name="phone2" value="<?=($type=="home")?$member->phone2:$member->{$type._phone2};?>" msg="연락처를"> -
						<input type="text" id="receiv-call3" style="width:60px" name="phone3" value="<?=($type=="home")?$member->phone3:$member->{$type._phone3};?>" msg="연락처를">
					</td>
				</tr>
				<tr>
					<th>배송지주소</th>
