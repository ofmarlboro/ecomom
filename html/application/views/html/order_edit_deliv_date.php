	...
	<div id="wrap" class="layout_type2 sub_layout">
		...
		?>
			<div class="layer_pop_inner">
				...
				<div class="bg clearfix">
					...
					<div class="ac bd">
						<a href="javascript:;" class="btn_big" onclick="change_form_send_none()">변경</a>
		...
		?>
			<div class="layer_pop_inner">
				<h1>배송일 변경</h1>
				<div class="bg clearfix">
				<p class="bu03"><?=$arr_deliv_date_to_count[$deliv_info->deliv_date]?$arr_deliv_date_to_count[$deliv_info->deliv_date]."회차 ":"";?> <?=$deliv_info->deliv_date?> (<?=numberToWeekname($deliv_info->deliv_date)?>) 변경하실 날짜를 선택하세요.</p>
					<p class="blue fs12 mt20">※ 배송일을 변경하시면 배송되는 식단이 변경되므로 꼭 확인해주세요.</p>
					<p class="blue fs12 mt10">※ 장기간 연장이 필요 시 “배송 일시정지”를 이용하세요.</p>
					<p class="blue fs12 mt10">※ 변경 가능한 날짜만 클릭됩니다.<br>
					...
					<div class="ac bd">
						<a href="javascript:;" class="btn_big" onclick="change_form_send()">변경</a>
						<a href="javascript:;" class="btn_big" onclick="self.close()">취소</a>
					</div>
				</div>
				<a href="javascript:;" class="btn_close" onclick='self.close();'></a>
