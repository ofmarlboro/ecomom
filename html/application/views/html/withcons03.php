			...
			<div class="my_cont clearfix">
				<div class="study_c">
					...
					<div class="study_contents">
						아기가 커 나가면 모유나 분유만으로 필요한 영양분을 다 섭취하기에는 충분하지 않은 때가 온답니다. 곧 이가 날 테니,
덩어리 음식을 먹는 연습도 해 나가야겠죠.
아이가 탈 없이 튼튼하게 자라기 위해서는 무엇보다 고른 영양과 올바른 식습관이 필요하지요. 아기의 발달 단계에 따라 유동식, 
반유동식, 고형식…… 이렇게 차근차근 나아가야 합니다.
					...
					<div class="study_contents">
						<div class="tblTy02">
							...
							<table>
								<tr>
									<th>0~3개월</th>
									<td>이유식을 시작하는 단계가 아니에요.
모유나 분유만 먹여야 한답니다.
</td>
								</tr>
								<tr>
									<th>4~6개월</th>
									<td>빠른 아가들은 4개월에 접어들면 쌀미음으로 이유식을 시작하지요. 모유를 먹이는 아가는
...
그 무렵부터는 철분이 꼭 필요하니까요. 이제 아기에게 붉은색 고기를 주어야 해요.
								...
								<tr>
									<th>7~8개월</th>
									<td>이제 알갱이가 조금씩 보이는 묽은 죽을 먹기 시작합니다. 7개월 이후에는 다섯 가지 식품군을
골고루 먹여야 하지요.
...
이유식을 먹기 시작합니다.
								...
								<tr>
									<th>9~12개월</th>
									<td>이유식이 아기의 주식이 되는 시기입니다. 소화력이 좋아지는 시기라 이유식 양을 전보다
늘려 주어야 합니다.
...
<tr>
									<th>12개월 이후</th>
									<td>진밥을 먹기 시작합니다. 음식을 흘리더라도 혼자 먹는 버릇을 들여야 합니다.
