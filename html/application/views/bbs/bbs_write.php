					...
					<ul class="board-write-form">
						...
						<li>
							<div class="write-editor">
								...
								<? }else{ //네이버 에디터 사용??>
								<textarea name="tx_content" id="tx_content" rows="10" cols="50" style="width:100%; height:412px; display:none;"><? echo isset($row->content) ? $row->content : "";?></textarea>
								<?	 }	?>
							</div>
						</li>
						...
						<? if($bbs->nospam==1){?>
						<li><div class="field-label"><label for="write-number">보안문자</label></div>
							<div class="field-form">
								<div class="spam_div">
									<?=$imgData?>
								</div>
								<input type="text" id="write-number" value="" name="spam_code" maxlength="5" style="width:70px;">
...
nhn.husky.EZCreator.createInIFrame({
	...
	function parseHTML(val){
		...
		console.log(oEditors.getById["tx_content"].getIR());
